export const faqSections = [
  {
    ...
    },
    {
        ...
        faqs: [
            {
                question: 'What are the pricing plan tiers?',
                answer: JSON.stringify([
                  { name: 'Launchpad', price: 99, supportRequests: 1, systemUpdates: 'Annual', includedHours: 1, extras: 'Light support & uptime stability' },
                  { name: 'Momentum', price: 149, supportRequests: 3, systemUpdates: 'Annual', includedHours: 3, extras: 'Uptime monitoring, quick response time' },
                  { name: 'Ascent', price: 249, supportRequests: 5, systemUpdates: 'Semi-Annual', includedHours: 5, extras: 'Performance insights, analytics, strategy reviews' },
                  { name: 'Continuum', price: 449, supportRequests: 'High-volume', systemUpdates: 'Quarterly + SEO Optimization', includedHours: '5+', extras: 'SEO audits, content refreshes, long-term planning', note: 'Starting at' },
                ], null, 2)
            },
            {
                question: 'Tell me about Banked Hours.',
                answer: JSON.stringify({
                  ...
                  details: [ { plan: 'Launchpad', hours: 1 }, { plan: 'Momentum', hours: 3 }, { plan: 'Ascent & Continuum', hours: 5 } ],
                  usage: [ 'Use hours for enhancements, tweaks, or quick builds', 'Unused hours roll over for 90 days', 'After 90 days, unused hours expire' ],
                  notes: [ 'Banked Hours are billed at a discounted rate of $150/hr if exceeded.', 'Roll over hours are capped at 90 days—after which they expire.', 'Work exceeding the plan or unrelated to the original scope may require a new estimate.', 'Unused Banked Hours cannot be refunded or exchanged.', 'Priority support is given to clients with active After Care Plans.' ],
                  rates: [ { type: 'Included work', rate: 150 }, { type: 'New clients or non-plan holders', rate: 250 } ],
                }, null, 2)
            },
            {
                question: 'What contract discounts do you offer?',
                answer: JSON.stringify([
            ...
            {
                question: 'What are common use cases for After Care Plans?',
                answer: JSON.stringify([
                  'Content updates', 'Design improvements', 'AI chat optimizations', 'SEO & performance tuning', 'Accessibility or legal compliance updates', 'Embedded tool upgrades',
                ], null, 2)
            },
            {
                question: 'Are there any other notes about After Care plans?',
                answer: JSON.stringify([
